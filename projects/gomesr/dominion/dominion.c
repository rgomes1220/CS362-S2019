...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case smithy:
        return smithyCard(currentPlayer, state,handPos, 0);
    //   //+3 Cards
    //   for (i = 0; i < 3; i++)
	// {
	//   drawCard(currentPlayer, state);
    ...
    case village:
        return villageCard(currentPlayer, state,handPos, 0);
        // //+1 Card
        // drawCard(currentPlayer, state);
        //
        // //+2 Actions
    ...
    case great_hall:
        return greatHallCard(currentPlayer, state,handPos, 0);
      // //+1 Card
      // drawCard(currentPlayer, state);
      //
      // //+1 Actions
    ...
    case embargo:
        return embargoCard(currentPlayer, choice1, state, handPos,1);
    //   //+2 Coins
    //   state->coins = state->coins + 2;
    //
